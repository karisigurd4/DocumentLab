...
---
This is a solution for data extraction from images of documents. You pass in an bitmap of a document and a set of queries and you get extracted data in structured json. 
