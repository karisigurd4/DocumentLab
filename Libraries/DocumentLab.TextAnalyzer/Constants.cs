namespace DocumentLab.TextAnalyzer
{
  ...
  public static class Constants
  {
    ...
    public static string TextTypeDataFilePath = $"Data\\Context\\{DefaultLanguage}\\";
    ...
    public static string TextTypeDefinitionConfigurationPath = "data\\configuration\\TextTypeDefinitions.json";
    ...
    public static TextTypeDefinition[] TextTypeDefinitions = JsonSerializer.FromFile<TextTypeDefinition[]>(TextTypeDefinitionConfigurationPath);
