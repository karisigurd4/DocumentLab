namespace DocumentLab
{
  ...
  public static class FluentQueryExtensions
  {
    ...
    public static FluentQuery Match(this FluentQuery response, TextType textType, params string[] matchText) => MatchBase(response, textType.ToString(), matchText);
    ...
    public static string Capture(this FluentQuery response, TextType captureTextType) => CaptureBase(response, captureTextType.ToString());
    ...
    {
      return CaptureNamedBase(response, captureTextType.ToString(), propertyName);
    }
    ...
    public static string FindValueForLabel(this FluentQuery response, TextType textTypeOfValue = TextType.Text, int maxSteps = 6, params string[] labelInDocument)
      => FindValueForLabelBase(response, textTypeOfValue.ToString(), maxSteps, labelInDocument);
    ...
    public static string GetValueAtLabel(this FluentQuery response, Direction direction, TextType textTypeOfValue = TextType.Text, params string[] labelInDocument)
      => GetValueAtLabelBase(response, direction, textTypeOfValue.ToString(), labelInDocument);
    ...
    public static string[] GetAny(this FluentQuery response, TextType textType)
      => GetAnyBase(response, textType.ToString());
    ...
    {
      return response.AppendToScript(matchText.Count() > 0 ? $"{textType}({string.Join("||", matchText)})" : textType);
    }
